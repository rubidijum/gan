...
if __name__ == "__main__":
	...
	discriminator = networks_improve.DiscriminatorNet().cuda()
	generator = networks_improve.GeneratorNet().cuda()
	...
	for epoch in range(num_epochs):
		for n_batch, real_batch in enumerate(data_loader):
			...
			#generate real data
			real_data = Variable(networks_improve.images_to_vectors(real_batch)).cuda()
